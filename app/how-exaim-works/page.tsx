      ...
      <div className="container-wrapper">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 lg:gap-8 items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6">
              ...
              >
                <Link href="/book-a-demo">
                  <Button
                    size="lg"
                    className="rounded-full px-6 sm:px-8 py-4 sm:py-6 bg-gray-900 hover:bg-gray-800 text-white font-medium text-sm sm:text-base shadow-md hover:shadow-lg transition-all duration-300 w-full sm:w-auto"
                  >
                    Book a demo
          ...
          <motion.div
            ...
            className="relative w-full lg:w-full mt-6 lg:mt-0 px-4 sm:px-0"
          >
              ...
              >
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                    {/* Text content */}
                    <div className="p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[240px] sm:min-h-[280px]">
                      <div>
                        <motion.span
                          initial={{ opacity: 0 }}
                          animate={isInView ? { opacity: 1 } : {}}
                          transition={{ duration: 0.4, delay: index * 0.15 + 0.25 }}
                          className="inline-block text-xs sm:text-sm font-semibold text-primary-600 mb-2"
                        >
                          Step {step.number}
                        </motion.span>
                        <motion.h3
                          ...
                          className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-3 md:mb-4 leading-tight"
                        >
                          {step.title}
                        </motion.h3>
                        <motion.p
  ...
  return (
    <section ref={ref} className="section-padding bg-white">
      <div className="container-wrapper">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-primary-50 rounded-xl p-4 sm:p-6 md:p-8 shadow-lg border border-gray-100">
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 lg:gap-8 items-center">
            {/* Input Stage */}
            <motion.div
      ...
      <div className="container-wrapper">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-lg border border-gray-100">
              <h3 className="font-bold text-sm sm:text-base md:text-lg text-gray-900 mb-3 md:mb-4">Key Benefits</h3>
              <ul className="space-y-3 sm:space-y-4 md:space-y-6 text-sm sm:text-base text-gray-600">
  ...
  return (
    <section ref={ref} className="section-padding bg-white">
      <div className="container-wrapper">
        ...
        <div className="bg-gray-50 rounded-xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-lg border border-gray-100 overflow-x-auto">
          <div className="min-w-[600px] sm:min-w-0">
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-2 sm:py-3 md:py-4 px-2 sm:px-4 font-semibold text-xs sm:text-sm md:text-base text-gray-900">Feature</th>
                  <th className="text-center py-2 sm:py-3 md:py-4 px-2 sm:px-4 font-semibold text-xs sm:text-sm md:text-base text-gray-900">Traditional / Multiple Tools</th>
                  <th className="text-center py-2 sm:py-3 md:py-4 px-2 sm:px-4 font-semibold text-xs sm:text-sm md:text-base text-gray-900">ExAIm</th>
                </tr>
              </thead>
              <tbody>
                {features.map((item, index) => (
                  ...
                  >
                    <td className="py-2 sm:py-3 md:py-4 px-2 sm:px-4 text-xs sm:text-sm md:text-base text-gray-700 leading-relaxed">{item.feature}</td>
                    <td className="py-2 sm:py-3 md:py-4 px-2 sm:px-4 text-center">
                      {item.traditional ? (
                        <Check className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 mx-auto" />
                      ) : (
                        <Minus className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 mx-auto" />
                      )}
                    </td>
                    <td className="py-2 sm:py-3 md:py-4 px-2 sm:px-4 text-center">
                      {item.exaim ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {stakeholders.map((stakeholder, index) => (
            <motion.div
              ...
              className="bg-white rounded-xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-lg hover:shadow-xl transition-all border border-gray-100 cursor-pointer"
            >
              <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${stakeholder.color} rounded-xl flex items-center justify-center mb-4 sm:mb-6 shadow-lg`}>
                <stakeholder.icon className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 md:mb-4">{stakeholder.title}</h3>
              <ul className="space-y-3 sm:space-y-4 md:space-y-6">
                {stakeholder.benefits.map((benefit, i) => (
                  <li key={i} className="text-gray-600 flex items-start gap-2 text-xs sm:text-sm leading-relaxed">
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <Link href="/book-a-demo" className="group">
                <Button
                  size="lg"
                  className="px-4 sm:px-6 md:px-8 py-3 md:py-4 bg-white text-primary-600 rounded-lg text-sm sm:text-base md:text-lg font-semibold hover:shadow-xl transition-all flex items-center gap-2 w-full sm:w-auto justify-center"
                >
                  Book a demo
