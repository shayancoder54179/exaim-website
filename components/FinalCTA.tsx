  ...
  return (
    <section id="contact" ref={ref} className="section-padding bg-gradient-to-br from-primary-600 via-secondary-600 to-primary-700 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto container-wrapper text-center">
        ...
        >
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-6 md:mb-8 leading-tight px-4">
            Get started with ExAIm today
          </h2>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-white/90 mb-8 md:mb-10 lg:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
          ...
          <div className="flex justify-center items-center px-4">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <Link
                href="/book-a-demo"
                prefetch={true}
                className="group px-4 sm:px-6 md:px-8 py-3 md:py-4 bg-white text-primary-600 rounded-lg text-sm sm:text-base md:text-lg font-semibold hover:shadow-xl transition-all flex items-center gap-1 sm:gap-2 w-full sm:w-auto justify-center focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600 min-h-[48px]"
              >
